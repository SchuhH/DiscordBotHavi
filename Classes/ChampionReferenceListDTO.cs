...
namespace DiscordBotHavi.Classes
{
    ...
    public partial class Welcome
    {
        public static Welcome FromJson(string json) => JsonConvert.DeserializeObject<Welcome>(json, DiscordBotHavi.Classes.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Welcome self) => JsonConvert.SerializeObject(self, DiscordBotHavi.Classes.Converter.Settings);
    }
